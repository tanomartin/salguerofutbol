...
FCKConfig.ToolbarSets['custom'] = [
	['FontNameSimple','FontSizeSimple','-','Bold','Italic','JustifyLeft','JustifyCenter','JustifyRight','TextColor','-',
	'UnorderedList','Outdent','Indent','-','RemoveFormat']
] ;

FCKConfig.ToolbarSets['custom2'] = [
	['FitWindow','Source','-','NewPage','Preview','Print','-','TextColor','BGColor','-', 'SelectAll','RemoveFormat','Copy','Paste'],
	['FontNameSimple','FontSizeSimple','-',
	'Bold','Italic','JustifyLeft','JustifyCenter','JustifyRight','-','OrderedList','UnorderedList','Outdent','Indent']
] ;
