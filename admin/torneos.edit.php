        ...
        <div class="mod_article block" id="register">
                ...
                <div class="ce_table">
                  ...
                  <table summary="Personal data" cellpadding="0" cellspacing="0">
                    <tbody>
                      ...
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Nombre Página</label>
                          <span class="mandatory">*</span></td>
                      ...
                      <tr class="even">
                        <td class="col_0 col_first"><label for="nombre">Fecha Inicio</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><input name="fechaInicio" type="text" id="fechaInicio" value="<?php echo $fechaInicio; ?>" size="8" readonly="readonly" class="required"/>
                          <a href="javascript:show_calendar('document.form_alta.fechaInicio', document.form_alta.fechaInicio.value);" <?= $disabled ?> > <img src="../_js/calendario2/cal.gif" width="16" height="16" border="0" /> </a> 
                      </tr>
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Fecha Fin</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><input name="fechaFin" type="text" id="fechaFin" value="<?php echo $fechaFin; ?>" size="8" readonly="readonly" class="required"/>
                          <a href="javascript:show_calendar('document.form_alta.fechaFin', document.form_alta.fechaFin.value);" <?= $disabled ?> > <img src="../_js/calendario2/cal.gif" width="16" height="16" border="0" /> </a> 
                      </tr>
                      </tr>
                      
                      <tr class="even">
                        <td class="col_0 col_first"><label for="nombre">Logo Principal</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><input name="logoPrincipal" id="logoPrincipal" class="" type="file" <?= $disabled ?> >
                          <? if ($datos[0]["logoPrincipal"] != "" ) { ?>
                          <a href="../logos/<?= $datos[0]["logoPrincipal"] ?>" target="_blank"> Imagen</a>
                          <? } ?>
                        </td>
                      </tr>
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Logo para el menú</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><input name="logoMenu" id="logoMenu" class="" maxlength="50" type="file" <?= $disabled ?> >
                          <? if ($datos[0]["logoMenu"] != "" ) { ?>
                          <a href="../logos/<?= $datos[0]["logoMenu"] ?>" target="_blank"> Imagen</a>
                          <? } ?>
                        </td>
                      </tr>
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Logo P&aacute;gina</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><input name="logoPagina" id="logoPagina" class="" maxlength="50" type="file" <?= $disabled ?> >
                          <? if ($datos[0]["logoPagina"] != "" ) { ?>
                          <a href="../logos/<?= $datos[0]["logoPagina"] ?>" target="_blank"> Imagen</a>
                          <? } ?>
                        </td>
                      </tr>
                      <tr class="even">
                        <td class="col_0 col_first"><label for="nombre">Activo</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><input type="checkbox"  <? if ($datos[0]["activo"] == "1" ) { ?> checked="checked" <? } ?> name="activo" id="activo" <?= $disabled ?> ></td>
                      </tr>
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Color</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><select name="color" id="color" class="validate-selection" <?= $disabled ?>>
          ...
          <div class="ce_text g4 xpln block">
            <p><strong>Datos del Torneo</strong><br>
              ...
              El campo <b>Logo P&aacute;gina</b> el el logo que se encuentra arriba a la izquierda en las p&aacute;ginas internas  que corresponden al torneo. </p>
