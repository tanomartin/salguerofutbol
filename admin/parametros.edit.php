                ...
                <div class="ce_table">
                  ...
                  <table summary="Personal data" cellpadding="0" cellspacing="0">
                    <tbody>
                      ...
                      <tr class="even">
                        <td class="col_0 col_first"><label for="valor">Valor</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><textarea name="valor" id="valor" class="required text" cols="50" rows="5"><?=$datos[0]["valor"]?>
</textarea></td>
                      </tr>
                    </tbody>
                  </table>
