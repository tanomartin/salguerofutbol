      ...
      <div class="inside">
        ...
        <div class="mod_article block" id="home">
          <div class="ce_text block">
            <h1>Confirmacion de Partidos:
              <?= $fecha[0]['nombre']." - ".$fecha[0]['torneo']." - ".$fecha[0]['categoria']?>
              <div style="float:right"> <img width="75" border="0" alt="reserva" title="Exportar Excel" onclick="javascript:migrar();" style="cursor:pointer" src="images/xls-icon.png"/>
                <? if ($partidos != NULL) { ?>
                <img width="75" border="0" alt="reserva" title="Enviar Correo Recordatorio" onclick="javascript:mail();" style="cursor:pointer" src="images/eml-icon.png"/>
                <? } ?>
                <img width="75" border="0" alt="reserva" title="volver" onclick="javascript:volver();" style="cursor:pointer" src="images/back-icon.png"/> </div>
            </h1>
            <br />
            <br />
            <div class="mod_listing ce_table listing block" id="partnerlist">
              ...
              <div align="center" style="float:left">
                <table id="partidos" width="400">
                  ...
                  <tr>
                    ...
                    <td nowrap><a href="javascript:confirmacion('<?= $partido['id'] ?>','<?=$partido['idEquipo1']?>','eliminar');"> <img width="25" border="0" alt="reserva" title="Eliminar Confirmacion" src="images/reenvio.png"/></a> <img width="25" border="0" alt="reserva" title="Confirmado" src="../img/check.ico"/> </td>
                    <? } else {?>
                    <td nowrap><a href="javascript:confirmacion('<?= $partido['id'] ?>','<?=$partido['idEquipo1']?>','confirmar');"><img width="25" border="0" alt="reserva" title="Confirmar" src="images/icono-up.gif"/></a> <img width="25" border="0" alt="reserva" title="Sin Confirmacion" src="../img/forbidden.ico"/> </td>
                    <? } ?>
                    ...
                    <td nowrap><img width="25" border="0" alt="reserva" title="Confirmado" src="../img/check.ico"/> <a href="javascript:confirmacion('<?= $partido['id'] ?>','<?=$partido['idEquipo2']?>','eliminar');"><img width="25" border="0" alt="reserva" title="Eliminar Confirmacion" src="images/reenvio.png"/></a> </td>
                    <? } else {?>
                    <td nowrap><img width="25" border="0" alt="reserva" title="Sin Confirmacion" src="../img/forbidden.ico"/> <a href="javascript:confirmacion('<?= $partido['id'] ?>','<?=$partido['idEquipo2']?>','confirmar');"><img width="25" border="0" alt="reserva" title="Confirmar" src="images/icono-up.gif"/></a> </td>
                    <? } ?>
                  </tr>
                  <?  	}
									 	} else {
              ...
              <div align="center" style="float:center">
                <table id="libres" style="width:400px">
                  ...
                  <tr>
                    <td style="font-size:16px"><?=$equipos['nombre'] ?></td>
                  </tr>
                  <?	}
							} else {
