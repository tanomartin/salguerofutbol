              ...
              <form name="frm_listado" id="frm_listado" action="<?=$_SERVER['PHP_SELF']?>" method="post">
				...
				?>
                  <tr>
                    ...
                    <td nowrap><a href="javascript:goles(<?=$datos[$i]["id"]?>);"> <img border="0" src="images/infoLoc.jpg" alt="Goles Anteriores" title="Goles Anteriores" width="20px" height="20px" /></a> </td>
                  </tr>
                  <? } }?>
                </table>
              </form>
