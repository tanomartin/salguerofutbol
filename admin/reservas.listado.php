            ...
            <div class="mod_listing ce_table listing block" id="partnerlist">
              ...
              <div align="center" style="float:left">
                <table id="conReserva" width="450">
                  ...
                  <tr>
                    ...
                    <td nowrap><a href="javascript:eliminarReserva(<?=$equipo['id_reserva']?>);"> <img border="0" src="images/icono-eliminar.gif" alt="eliminar" title="Eliminiar Reserva" width="20px" height="20px" /></a>
                    ...
                    <? if ($equipo['observacion'] != "") { ?>
                  <tr>
                    <td colspan="3" style="text-align:justify">Obs: <b>
                      <?=$equipo['observacion'] ?>
                      </b></td>
                  </tr>
                  <? } ?>
              ...
              <div align="center" style="float:right">
                <table id="sinReserva" width="450">
                  ...
                  <tr>
                    <td style="font-family:Geneva, Arial, Helvetica, sans-serif; font-size:17px"><?=$equipo['nombre'] ?></td>
                    <td><a href="javascript:cargarReserva(<?=$equipo['id_equipo']?>);"> <img border="0" src="images/icono-editar.gif" alt="ver" title="Cargar Reserva" width="20px" height="20px" /></a> </td>
                  </tr>
                  <?	} 
										}?>
                </table>
            ...
            <div class="mod_listing ce_table listing block" id="partnerlist">
              <div align="center">
                ...
                <table id="reservas" name="reservas" style="font-size:8.5px">
                  <tr>
                    <td style="background-color:#CE6C2B; color:#FFFFFF"><b>HORAS | EQUIPOS</b></td>
