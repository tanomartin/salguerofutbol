      ...
      <div class="inside">
        ...
        <div class="ce_text block">
          <h1>Correo Reserva:
            ...
            <div style="float:right"> <img width="75" border="0" alt="enviar" title="Enviar" onclick="javascript:enviar();" style="cursor:pointer" src="images/send_mail.png"/> <img width="75" border="0" alt="volver" title="Volver" onclick="javascript:volver();" style="cursor:pointer" src="images/back-icon.png"/> </div>
          </h1>
        </div>
              ...
              <form name="form_alta" id="form_alta" action="<?=$_SERVER['PHP_SELF']?>" method="post"  enctype="multipart/form-data">
                ...
                <div align="center" style="float:left">
                  <table id="mail" width="450">
                    ...
                    <tr>
                      ...
                      <td><?=$equipo['email'] ?></td>
                      <td nowrap><? if ($equipo['seenvio']) { ?>
                        <img border="0" src="../img/check.ico" id="info" alt="info" width="20px" height="20px" /> <a href="javascript:eliminarEnvio(<?=$equipo['id_equipo']?>);"><img border="0" title="Reenviar" src="images/reenvio.png" id="info" alt="info" width="20px" height="20px" /></a>
                        <? } else { ?>
                ...
                <div align="center" style="float:right">
                  <table id="cuerpo" width="450">
                    <th>Correo</th>
                    <tr>
                      <td><div align="center" style="float:right">
                          <div align="left">
                            <h2>Asunto</h2>
                            <p>
