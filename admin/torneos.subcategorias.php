<?	include_once "include/config.inc.php";
	...
	$oObj = new Categorias();
	$datosCat = $oObj->get($_POST['id_categoria']);

	$oObj = new TorneoCat();
	$datos = $oObj->getBySubCategorias($_POST['id'],$_POST['id_categoria']);
...
<script language="javascript">
	...
	function nuevo(){
		...
		document.frm_listado.accion.value = "editarSubcategorias";
            ...
            <div class="mod_listing ce_table listing block" id="partnerlist">
              <form name="frm_listado" id="frm_listado" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                ...
                <table width="928">
                  ...
                  <? if (count($datos) == 0) { ?>
                  <tr>
                    <td colspan="4" align="center">No existen subcategor&iacute;as para este Torneo</td>
                  </tr>
                  <? } else { 
				...
				?>
                  <tr style="vertical-align:middle" >
                    ...
                    <td nowrap><a href="javascript:borrar(<?=$datos[$i]["id"]?>);"><img border="0" src="images/icono-eliminar.gif" alt="eliminar" title="eliminar" /></a> </td>
                  </tr>
                  <? } }?>
                </table>
              </form>
