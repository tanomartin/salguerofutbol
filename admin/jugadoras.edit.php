                    ...
                    <tbody>
                      ...
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Equipo</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><select name="idEquipo" id='idEquipo' <?= $disabled ?> class="validate-selection" >
                            <option value="-1">Seleccione un Equipo...</option>
                            <?php for($i=0;$i<count($aEquipos);$i++) { ?>
                            <option value="<?php echo $aEquipos[$i]['id'] ?>" <?php if ($datos[0]["idEquipo"] ==   $aEquipos[$i]['id'] ) echo "selected"; ?>><?php echo $aEquipos[$i]['nombre'] ?> </option>
                            <?php } ?>
                          </select>
                        </td>
                      </tr>
                      <tr class="even">
                        ...
                        <td class="col_1 col_last"><input name="fechaNac" type="text" id="fechaNac" value="<?php echo cambiaf_a_normal($datos[0]["fechaNac"]); ?>" size="10" readonly="readonly" />
                          <a href="javascript:show_calendar('document.form_alta.fechaNac', document.form_alta.fechaNac.value);"> <img src="../_js/calendario2/cal.gif" width="16" height="16" border="0" /> </a> </td>
                      </tr>
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Posici&oacute;n</label></td>
                        <td class="col_1 col_last"><select name="idPosicion" id='idPosicion' <?= $disabled ?>  >
                            <option value="-1">Seleccione una Posici&oacute;n...</option>
                            <?php for($i=0;$i<count($aPosicion);$i++) { ?>
                            <option value="<?php echo $aPosicion[$i]['id'] ?>" <?php if ($datos[0]["idPosicion"] ==   $aPosicion[$i]['id'] ) echo "selected"; ?>><?php echo $aPosicion[$i]['nombre'] ?> </option>
                            <?php } ?>
                          </select>
                        </td>
                      </tr>
                      <tr class="odd">
                        ...
                        <td class="col_1 col_last"><input name="goles" type="text" id="goles" value="<?php echo $datos[0]["goles"]; ?>" class="validate-digits" size="3"  <?= $disabled ?>/>
                        </td>
                      </tr>
                      <tr class="even">
                        <td class="col_0 col_first"><label for="nombre">Foto Preview</label></td>
                        <td class="col_1 col_last"><input name="fotoPreview" id="fotoPreview" class="" type="file"  <?= $disabled ?> >
                          <? if ($datos[0]["fotoPreview"] != "" ) { ?>
                          <a href="../fotos_jugadoras/<?= $datos[0]["fotoPreview"] ?>" target="_blank"> Imagen</a>
                          <? } ?>
                        </td>
                      </tr>
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Foto Grande</label></td>
                        <td class="col_1 col_last"><input name="fotoGrande" id="fotoGrande" class="" maxlength="50" type="file"  <?= $disabled ?>>
                          <? if ($datos[0]["fotoGrande"] != "" ) { ?>
                          <a href="../fotos_jugadoras/<?= $datos[0]["fotoGrande"] ?>" target="_blank"> Imagen</a>
                          <? } ?>
                        </td>
                      </tr>
                    </tbody>
