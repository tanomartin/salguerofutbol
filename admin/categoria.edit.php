      ...
      <div class="inside">
        ...
        <div class="mod_article block" id="register">
              ...
              <div class="formbody">
                <div class="ce_table">
                  ...
                  <table summary="Personal data" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr class="even">
                        <td class="col_0 col_first"><label for="id_opcion">Nombre Largo</label>
                      ...
                      <tr class="even">
                        <td class="col_0 col_first"><label for="id_opcion">Nombre P&aacute;gina </label>
                          <span class="mandatory">*</span></td>
          ...
          <div class="ce_text g4 xpln block">
            ...
            <p>EL campo <b>Nombre P&aacute;gina</b> se utiliza para el menú superior de Categor&iacute;as del las páginas internas</p>
            <span class="mandatory">*</span> son de ingreso obligatorio.
            </p>
          </div>
          <div class="clear"></div>
        </div>
