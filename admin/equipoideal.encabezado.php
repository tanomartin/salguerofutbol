          ...
          <div class="ce_text block">
            <div class="mod_listing ce_table listing block" id="partnerlist">
              ...
              <form name="frm_listado" id="frm_listado" action="<?=$_SERVER['PHP_SELF']?>" method="post">
                ...
                <!-- Fin filtros -->
                <div style="margin-left:20px; float:left" > <b>Torneo:</b>
                  <?= $datos1 ->torneo ?>
                  - <b>Categor&iacute;a:</b>
                  <?= $datos1 ->nombreLargo ?>
                  <? if ( $datos1 ->nombreCat != "") { echo " - ". $datos1 ->nombreCat; } ?>
                </div>
                <div align="right" style="margin-right:10px; margin-bottom:10px" >
                  <input class="button" onclick="javascript:volver()" type="button" value="Volver" />
                  &nbsp;&nbsp;
