...
<form name="form_alta" id="form_alta" action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
   ...
   <table width="108%" cellpadding="0" cellspacing="0" summary="Personal data">
      ...
      <tr class="even">
        ...
        <td class="col_1 col_last"><input name="fotoLogo" id="fotoLogo" class="" type="file" ><? if ($datos[0]["fotoLogo"] != "" ) { ?><a href="../fotos_beneficios/<?= $datos[0]["fotoLogo"] ?>" target="_blank"> Imagen</a> <? } ?> </td>
      </tr>   
