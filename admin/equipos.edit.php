         	...
         	return listOnChange('idTorneo', '','categoriaList','categoria_data.php','advice1','idTorneoCat','idTorneoCat');" >
                      ...
                      <tr class="even">
						...
						?>
                            ...
                            <? if ( $aTorneoCat[$i]["nombreCat"] != "" ){ echo "- ". $aTorneoCat[$i]["nombreCat"]; } ?>
                            </option>
                            <?							
							}
						 }
                      ...
                      <tr class="odd">
                        ...
                        <td class="col_1 col_last"><input name="descuento_puntos" type="text" id="descuento_puntos" value="<?php echo $datos[0]["descuento_puntos"]; ?>" class="validate-digits" size="3"  <?= $disabled ?>/>
                        </td>
                      </tr>
                      <tr class="even">
                        <td class="col_0 col_first"><label for="nombre">Foto Preview</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><input name="fotoPreview" id="fotoPreview" class="" type="file"  <?= $disabled ?> >
                          <? if ($datos[0]["fotoPreview"] != "" ) { ?>
                          <a href="../fotos_equipos/<?= $datos[0]["fotoPreview"] ?>" target="_blank"> Imagen</a>
                          <? } ?>
                        </td>
                      </tr>
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Foto Grande</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><input name="fotoGrande" id="fotoGrande" class="" maxlength="50" type="file"  <?= $disabled ?>>
                          <? if ($datos[0]["fotoGrande"] != "" ) { ?>
                          <a href="../fotos_equipos/<?= $datos[0]["fotoGrande"] ?>" target="_blank"> Imagen</a>
                          <? } ?>
                        </td>
                      </tr>
                      <tr class="even">
