      ...
      <div class="inside">
        ...
        <div class="mod_article block" id="register">
          <div class="ce_text block">
            <h1>
              <?=$operacion?>
              de contraseña para ingreso sistema de reserva</h1>
          </div>
          <!-- indexer::stop -->
                ...
                <div class="ce_table">
                  ...
                  <table summary="Personal data" cellpadding="0" cellspacing="0">
                    <tbody>
                      ...
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Contraseña</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><div id="error" style="color:#CC3300; font-weight:bold"></div>
