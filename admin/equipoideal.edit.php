          ...
          <div class="mod_registration  tableform block">
            <form name="form_alta" id="form_alta" action="<?=$_SERVER['PHP_SELF']?>" method="post"  enctype="multipart/form-data">
              ...
              <div class="formbody">
                <div class="ce_table">
                  <fieldset>
                  <legend>Datos de la Jugadora </legend>
                  </fieldset>
                  <table summary="Personal data" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr class="odd">
                        ...
                        <td class="col_1 col_last"><?= $aTorneos[0]['nombreTorneo'] ?>
                        </td>
                      </tr>
                      <tr class="even">
                        <td class="col_0 col_first"><label for="nombre">Categoría</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><?= $aTorneos[0]['nombreLargo'] ?>
                          <? if($aTorneos[0]['nombreCat'] != ""){ echo " - " .$aTorneos[0]['nombreCat'] ; } ?></td>
                      </tr>
                      <tr class="odd">
                      ...
                      <tr class="even">
                        <td class="col_0 col_first"><label for="nombre">Jugadora </label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><span id="JugadoraList">
                      ...
                      <tr class="odd">
                        <td class="col_0 col_first"><label for="nombre">Posici&oacute;n en la Cancha </label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><select name="idPosicion" id="idPosicion" >
                            <? for($i=1; $i<=5; $i++) { ?>
                            <option value="<?= $i ?>">
                            <?= $i ?>
                            </option>
