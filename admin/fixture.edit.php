            ...
            listOnChange('idTorneoCat', '', 'fechaList','fecha_data.php','advice2','idFecha','idFecha');" >
                      ...
                      <tr class="even">
                        <td class="col_0 col_first"><label for="nombre">Fecha Partido</label>
                          <span class="mandatory">*</span></td>
                        <td class="col_1 col_last"><input name="fechaPartido" type="text" id="fechaPartido" value="<?php echo cambiaf_a_normal($datos[0]["fechaPartido"]); ?>" size="8" readonly="readonly" class="required"/>
