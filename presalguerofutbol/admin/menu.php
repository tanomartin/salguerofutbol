...
<ul class="level_1">
	...
	<li class="<? if( $_POST["menu"]== "Secciones") echo "active"; ?>  submenu "><span class="submenu">Conf. del Torneo</span>
	  <ul style="visibility: visible; opacity: 1;" class="level_2">
		...
		<li>
	      <a href="#" title="Categor&iacute;as" class="first" onclick="this.blur(); ir('Categor&iacute;as','','categorias.php','categorias.php')">Zonas</a>
        </li>
	    <li>
	...
	<li class="<? if( $_POST["menu"]== "Gestion") echo "active"; ?>  submenu "><span class="submenu">Gesti&oacute;n del Torneo</span>
	  <ul style="visibility: visible; opacity: 1;" class="level_2">
	    <li class="first">
	      <a href="#" title="Fixture"  class="first"  onclick="this.blur(); ir('Fixture', '', 'fixture.php', 'fixture.php')">Partidos</a>
        </li>       
      </ul>
    </li> 
